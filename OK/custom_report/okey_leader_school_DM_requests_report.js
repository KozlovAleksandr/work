...
for (_request in _requests) {
  ...
  if (_requestDoc != undefined) {
    ...
    _obj.experience_category = _request_te.custom_elems.ObtainChildByKey("f_t1wa").value;
    _obj.moving = _request_te.custom_elems.ObtainChildByKey("f_bdmh").value == 'true' ? "Да" : "";
    _obj.mentor = _request_te.custom_elems.ObtainChildByKey("f_t779").value == 'true' ? "Да" : "";
