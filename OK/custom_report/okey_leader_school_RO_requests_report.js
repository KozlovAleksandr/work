...
for (_request in _requests) {
  ...
  if (_requestDoc != undefined) {
    ...
    //    _obj.experience_category = _request_te.custom_elems.ObtainChildByKey("f_nf6v").value;
    //    _obj.moving = _request_te.custom_elems.ObtainChildByKey("f_9ibs").value == 'true' ? "Да" : "";
    //    _obj.mentor = _request_te.custom_elems.ObtainChildByKey("f_fgoa").value == 'true' ? "Да" : "";
